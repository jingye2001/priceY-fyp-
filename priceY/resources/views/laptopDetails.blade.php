...
<div class="row">
  <div class="col-md-12 col-sm-12">
      <h2 class="title">Laptop Details</h2> 
      <div class="container">
        <div class="product-container">            
          ...
          <div class="product-details">
              ...
              <a href="{{ route('compareLaptop', ['id' => $laptops->id]) }}" class="btn btn-info">Compare</a>
...
<script>
  ...
  $(document).ready(function(){
    var rating_data = 0;
    var laptop_id = @if ($laptops) '{{ $laptops->id }}' @else null @endif;
