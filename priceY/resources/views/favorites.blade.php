        ...
        @foreach ($favorites as $favorite)
            <div class="col-md-3 col-6">
                ...
                <div class="product-image">
                    <a href="{{ route('laptopDetails', ['id' => $favorite->laptop->id]) }}" class="image">
                    ...
                    <ul class="product-links">
                        ...
                        <li><a href="{{ route('compareLaptop', ['id' => $favorite->laptop->id])}}"><img src="{{ asset('images/compare logo.jpg') }}"></a></li>
                    </ul>
                    <a href="{{ route('laptopDetails', ['id' => $favorite->laptop->id]) }}" class="add-to-cart">View laptop</a>
                </div>
